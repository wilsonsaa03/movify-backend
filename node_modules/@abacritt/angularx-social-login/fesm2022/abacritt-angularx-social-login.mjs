...
import { EventEmitter, InjectionToken, inject, NgZone, Injector, Injectable, NgModule, ElementRef, Input, Directive } from '@angular/core';
...
class BaseLoginProvider {
    constructor() {
        this.onHasErrorChange = new EventEmitter();
        this.onIsLoadedChange = new EventEmitter();
        this.hasError = false;
        this.isLoaded = false;
    }
    loadScript(id, src, onload, parentElement = null, onError = null) {
...
const SOCIAL_AUTH_CONFIG = new InjectionToken('SocialAuthServiceConfig');
...
class SocialAuthService {
    ...
    constructor() {
         ...
         */
        this._config = inject(SOCIAL_AUTH_CONFIG);
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: SocialAuthService, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: SocialAuthService, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: SocialAuthService, decorators: [{
            type: Injectable,
...
class SocialLoginModule {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: SocialLoginModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.6", ngImport: i0, type: SocialLoginModule, imports: [CommonModule] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: SocialLoginModule, providers: [SocialAuthService], imports: [CommonModule] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: SocialLoginModule, decorators: [{
            type: NgModule,
            args: [{
...
class MicrosoftLoginProvider extends BaseLoginProvider {
    ...
    async signIn(options = undefined) {
...
class GoogleSigninButtonDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: GoogleSigninButtonDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.2.6", type: GoogleSigninButtonDirective, isStandalone: true, selector: "asl-google-signin-button", inputs: { type: "type", size: "size", text: "text", shape: "shape", theme: "theme", logo_alignment: "logo_alignment", width: "width", locale: "locale" }, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: GoogleSigninButtonDirective, decorators: [{
            type: Directive,
            args: [{
...
class GoogleSigninButtonModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: GoogleSigninButtonModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.6", ngImport: i0, type: GoogleSigninButtonModule, imports: [GoogleSigninButtonDirective], exports: [GoogleSigninButtonDirective] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: GoogleSigninButtonModule }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: GoogleSigninButtonModule, decorators: [{
            type: NgModule,
            args: [{
                    declarations: [],
...
export { AmazonLoginProvider, BaseLoginProvider, DummyLoginProvider, FacebookLoginProvider, GoogleLoginProvider, GoogleSigninButtonDirective, GoogleSigninButtonModule, MicrosoftLoginProvider, SOCIAL_AUTH_CONFIG, SocialAuthService, SocialLoginModule, SocialUser, VKLoginProvider };
